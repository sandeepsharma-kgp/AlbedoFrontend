...
<div>
    ...
    <b-collapse id="nav-collapse" is-nav>
      ...
      <b-navbar-nav class="ml-auto">  
          <a href="#" class = "call"><b-img :src="require('../static/icons/call.svg')" style="padding : 14px;"></b-img><h8 style="padding : 14px; padding-left:0px;">+91xxxxxxxxxx</h8></a>
          ...
          <b-img :src="require('../static/icons/man-user.svg')"></b-img>
